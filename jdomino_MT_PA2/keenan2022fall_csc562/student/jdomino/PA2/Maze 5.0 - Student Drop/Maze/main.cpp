...
int main(int argc, char *argv[]) 
{
...
#if !FINAL_SUBMIT
	char inFileName[INPUT_NAME_SIZE] = "Maze15Kx15K_J.data";
#else
	...
	Trace::out2("\n Maze: MTStudentSolver\n");
		...
		MTMazeStudentSolver stuSolverDFS(pMaze, MTMazeStudentSolver::SearchType::VECTOR);
		std::vector<Direction>* pStuSolutionDFS = stuSolverDFS.Solve();
		...
		// Verify solution - do not delete, it is not timed
		pMaze->checkSolution( *pStuSolutionDFS);

		// release memory
		delete pStuSolutionDFS;
		delete pMaze;
