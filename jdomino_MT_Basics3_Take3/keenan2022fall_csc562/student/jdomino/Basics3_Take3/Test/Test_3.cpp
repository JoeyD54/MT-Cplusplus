...
bool Test3_flag = false;

TEST_WITH_TEARDOWN(Unit_3, TestConfig::ALL)
{
#if Unit_3	
	...
	Student3 sA(Student3::Name::Lisa, 33);
	Student3 sB(Student3::Name::Jay, 555);
	Student3 sC(Student3::Name::Mike, 4444);
